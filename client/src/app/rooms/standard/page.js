    ...
    <div className="bg-gray-100 min-h-screen">
      ...
      <div className="container mx-auto my-5 px-4 py-8">
        ...
        <p className="text-blue-700 font-semibold mb-4">
          {roomCount} standard room{roomCount === 1 ? "" : "s"} available.
        </p>
        ...
        {roomCount === 0 ? (
          <div className="rounded-xl bg-white p-8 shadow-md text-center">
            ...
            <p className="text-gray-600">
              All standard rooms are currently unavailable. Please check back
              later.
            </p>
          </div>
        ) : (
