  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      <div className="container mx-auto my-5 px-4 py-8">
        <h1 className="text-3xl text-gray-800 font-bold mb-2">Deluxe Rooms.</h1>
        <p className="text-blue-700 font-semibold mb-4">
          {roomCount} deluxe room{roomCount === 1 ? "" : "s"} available.
        </p>
        <p className="text-gray-600 mb-8">
          Experience luxury and comfort in our deluxe rooms. Each room is
          thoughtfully designed with premium amenities, elegant furnishings, and
          stunning views to ensure your stay is unforgettable.
        </p>
        ...
        {roomCount === 0 ? (
          <div className="rounded-xl bg-white p-8 shadow-md text-center">
            ...
            <p className="text-gray-600">
              All deluxe rooms are currently unavailable. Please check back
              later.
            </p>
          </div>
        ) : (
