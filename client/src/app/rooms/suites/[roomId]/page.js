  ...
  return (
    <div>
      ...
      <header className="flex bg-white justify-between p-4 shadow-md items-center">
        <Link href="/rooms/suites" className="text-blue-600 font-bold">
          ← Back to Suites
        </Link>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md mb-8">
          ...
          <Link
            ...
            className="mt-6 inline-flex rounded-md bg-blue-600 px-6 py-3 text-white font-semibold hover:bg-blue-700 transition"
          >
            Book This Room
          </Link>
        </div>
